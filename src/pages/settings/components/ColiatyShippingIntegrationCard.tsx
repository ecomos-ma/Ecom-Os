...
function ColiatyShippingIntegrationCard({ onConnectionChange }: { onConnectionChange?: (connected: boolean) => void }) {
  ...
  return (
    <>
      ...
      <div className="group relative flex flex-col h-full overflow-hidden rounded-[24px] border border-base-border bg-base-surface p-6 shadow-sm shadow-black/[0.02] hover:scale-[1.02] hover:shadow-md transition-all duration-150">
        ...
        <div className="flex flex-col pb-4">
          <div className="mb-4 flex h-12 w-12 flex-none items-center justify-center rounded-2xl bg-base-raised overflow-hidden border border-base-border/50">
            <img src={getIntegrationLogo("coliaty") || ""} alt="Coliaty Delivery" className="h-full w-full object-contain object-center" />
          </div>
      ...
      {/* ── Configuration Modal ── */}
      {isColiatyModalOpen && (
        <div className="app-modal-backdrop fixed inset-0 flex h-dvh min-h-0 items-center justify-center overflow-hidden p-4" onClick={handleClose}>
          <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" />
          <div
            className="relative z-10 flex max-h-[calc(100dvh-2rem)] min-h-0 w-full max-w-lg flex-col overflow-hidden rounded-[28px] border border-base-border bg-base-surface shadow-2xl"
          ...
          >
            ...
            {/* Body */}
            <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-7 py-6"><div className="flex flex-col gap-4">
              <div>
