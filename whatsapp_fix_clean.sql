...
select
  ...
  true,
  array['1']::text[],
  'Mzyan Γ£à kteb lina l''adresse kamla dyalk.',
  'Smah lina, kteb l''adresse kamla b chi tafasil (quartier, rue, ville).',
  '≡ƒôì L''adresse dyalk:\n{{address}}\n\nIla s7i7a, kteb 4 bach n2akdo talab.',
  array['4', 'confirm', 'oui', '┘å╪╣┘à']::text[],
  true,
