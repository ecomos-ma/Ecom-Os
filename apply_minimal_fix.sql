-- Apply a minimal version that removes ALL subscription-related checks
-- This bypasses the RLS issue entirely by not touching subscription tables
...
begin
  ...
  -- Completely skip all subscription and limit checks to avoid RLS issues
